...
import { ShoppingCart, Star, Heart, Dog, Bone, Award, Filter } from 'lucide-react';
...
export const Shop: React.FC<ShopProps> = ({ addToCart }) => {
  ...
  // ---------------------------------------------------------------------------
  // GUÍA RÁPIDA PARA CAMBIAR FOTOS / QUICK GUIDE TO CHANGE PHOTOS:
  // 
  // 1. Guarda tu foto en: public/images/ (ejemplo: public/images/salmon.jpg)
  // 2. Busca la línea que dice "image:" abajo.
  // 3. Borra la URL de https://... y pon: "/images/salmon.jpg"
  // ---------------------------------------------------------------------------
  ...
  const products: Product[] = [
    // --- SNACKS (6 Items) ---
    {
      ...
      category: 'snack',
      price: 6.50,
      image: 'https://images.unsplash.com/photo-1599141014169-23c349377a06?auto=format&fit=crop&w=800&q=80', // Dried fish/treats
      description: '100% Natural Salmon (70%) with veggies. High in Omega-3.',
      tag: 'Best Seller'
    },
    {
      id: 's2',
      ...
      category: 'snack',
      price: 5.99,
      image: 'https://images.unsplash.com/photo-1623366302587-bca021d6616c?auto=format&fit=crop&w=800&q=80', // Raw meat/liver look
    ...
    },
    {
      ...
      category: 'snack',
      price: 6.20,
      image: 'https://images.unsplash.com/photo-1541592618-3aee694856f6?auto=format&fit=crop&w=800&q=80', // Meat chunks
      description: 'Human-grade Beef (70%) and veggies. A hearty reward.',
    },
    {
      id: 's4',
      name: 'Chicken & Veggie',
      category: 'snack',
      price: 5.99,
      image: 'https://images.unsplash.com/photo-1587593810167-a84920ea0781?auto=format&fit=crop&w=800&q=80', // Chicken
    ...
    },
    {
      ...
      category: 'snack',
      price: 6.50,
      image: 'https://images.unsplash.com/photo-1603048297172-c92544798d5e?auto=format&fit=crop&w=800&q=80', // Meaty
      description: 'Hypoallergenic Lamb (70%). Gentle on sensitive stomachs.',
      tag: 'Sensitive'
    },
    {
      id: 's6',
      ...
      category: 'snack',
      price: 5.50,
      image: 'https://images.unsplash.com/photo-1592394533824-9436d7d25d41?auto=format&fit=crop&w=800&q=80', // Veggies
      description: '100% Plant-based goodness. Sweet potato & carrot.',
      tag: 'Vegan'
    },
    ...
    // --- TOYS (16 Items) ---
    {
      ...
      description: 'Heavy duty rubber tire for aggressive chewers.',
      tag: 'Tough'
    },
    {
      id: 't2',
    ...
    },
    {
      ...
      description: 'Mental stimulation game. Hide treats inside.',
      tag: 'Smart'
    },
    {
      id: 't5',
    ...
    },
    {
      ...
      description: 'Extra long 3-knot rope for interactive play.',
      tag: 'Interactive'
    },
    {
      id: 't8',
    ...
    },
    {
      ...
      description: 'Nylon infused with bacon flavor. Impossible to destroy.',
      tag: 'Tough'
    },
    {
      id: 't10',
      ...
      description: 'Foldable tunnel for backyard training and fun.',
    },
    {
      id: 't11',
      name: 'Snuffle Mat XL',
      ...
      description: 'Hide kibble in the fabric strips for nose work.',
      tag: 'Brain Game'
    },
    {
      id: 't12',
    ...
    },
    {
      ...
      description: 'Bright orange ring that never sinks. Perfect for lakes.',
    },
    {
      id: 't14',
      name: 'Plush Donut',
    ...
    },
    {
      ...
      description: 'Launches tennis balls automatically for endless fetch.',
      tag: 'Tech'
    }
  ];
            ...
            <div key={product.id} className="group flex flex-col">
              ...
              <div className="relative aspect-[4/5] bg-gray-50 rounded-[2rem] overflow-hidden mb-6 group-hover:shadow-2xl transition-all duration-500 border border-gray-100 group-hover:border-brand-teal/30">
                ...
                <img 
                  src={product.image} 
                  alt={product.name} 
                  // Fallback has been removed/changed to a generic colored box with text to avoid ugly broken image icons if something fails
                  onError={(e) => { 
                    e.currentTarget.onerror = null; 
                    e.currentTarget.style.display = 'none';
                    e.currentTarget.parentElement!.style.backgroundColor = '#f0f0f0';
                    e.currentTarget.parentElement!.innerHTML += '<div class="absolute inset-0 flex items-center justify-center text-gray-400 font-bold">Image Coming Soon</div>';
                  }} 
