  ...
  return (
    <div className="relative w-full min-h-[85vh] flex flex-col md:flex-row bg-brand-teal overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-16 md:px-16 lg:px-24 text-white relative z-10 order-2 md:order-1">
        ...
        {/* New Badge */}
        <div className="inline-flex items-center self-start gap-2 px-4 py-2 rounded-full bg-brand-pink text-white text-sm font-bold mb-8 shadow-lg transform -rotate-1 border border-white/20 hover:scale-105 transition-transform cursor-default">
            <Star size={16} className="text-brand-yellow fill-current animate-pulse" />
        ...
        <div className="flex flex-col sm:flex-row gap-5 mb-12">
          ...
          <div className="relative group">
            ...
            <button 
              ...
              className="relative w-full sm:w-auto bg-brand-orange hover:bg-orange-500 text-white text-xl font-bold px-10 py-5 rounded-full shadow-xl flex items-center justify-center gap-3 transition-all transform group-hover:translate-y-[-2px]"
            >
              Shop Now
          ...
          <Button 
            ...
            variant="outline" 
            size="lg"
            className="border-2 border-white/30 text-white hover:bg-white hover:text-brand-teal text-xl px-10 py-5 rounded-full hover:border-white backdrop-blur-sm"
          >
            Services
          </Button>
        </div>
        ...
        <div className="flex items-center gap-6 border-t border-white/20 pt-8 mt-2 animate-fade-in">
           ...
           <div className="relative group cursor-help shrink-0 transform hover:scale-105 transition-transform duration-300">
              <div className="w-24 h-24 bg-white rounded-full shadow-[0_0_25px_rgba(255,255,255,0.2)] flex items-center justify-center border-4 border-white/80">
                 <img 
                   src="/images/seal.png" 
                   ...
                   onError={(e) => {
                     ...
                     e.currentTarget.parentElement!.innerHTML = `<span class="text-brand-dark font-bold text-center text-[10px] leading-tight">UK<br/>GOVT<br/>APPROVED</span>`;
                   }}
                 />
              </div>
              {/* Verified Checkmark Badge */}
              <div className="absolute -top-1 -right-1 bg-[#00C853] text-white rounded-full p-1.5 border-[3px] border-brand-teal shadow-sm">
           ...
           <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3 mt-1">
                 <p className="font-mono text-brand-yellow text-xs opacity-80">License No: U1596090</p>
